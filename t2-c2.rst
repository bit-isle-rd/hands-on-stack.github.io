...
コマンド実行の様子::
  ...
  +--------------------------------------+--------------------------+--------+------------+-------------+--------------------+
  | 16b659aa-abe5-4d08-88ee-3803aae1b1cd | seminer11-ansible-server | ACTIVE | -          | Running     | private=10.50.16.1 |
...
コマンド実行の様子::
  ...
  (venv)# vi inventory.ini ←hostname_prefixを自身の環境にあわせてseminerNN-testに修正):
  ...(中略)...
  [test]
...
コマンド実行の様子::
  ...
  PLAY RECAP ********************************************************************
  10.50.16.10                : ok=3    changed=0    unreachable=0    failed=0
  10.50.16.11                : ok=3    changed=0    unreachable=0    failed=0

  (venv)# curl 10.50.16.10
    ... (レスポンスがあることを確認)
  (venv)# curl 10.50.16.11
    ... (レスポンスがあることを確認)
  ---------ここまで---------
...
コマンド実行の様子::
  ...
  ---------ここから---------
  [root@seminer11-ansible-server ~]# logout
